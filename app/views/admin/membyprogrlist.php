...
<html lang="en">
<head>
  <title>Listapp | Members List By Programme</title>
  <meta charset="utf-8">
...
<body>
    <div class="container">
        <div class="row">
            <div class="back-btn">
                <a class="btn btn-success" href="<?php echo BASE_URL;?>/Phone/createListByProgramme">Back</a>
         ...
         buttons: [
          {
              ...
              customize: function (win) {
                  $(win.document.body).find('table').addClass('display').css('font-size', '19px');
